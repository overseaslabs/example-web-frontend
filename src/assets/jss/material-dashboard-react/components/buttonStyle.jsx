...
const buttonStyle = {
  ...
  primary: {
    ...
    boxShadow:
      "0 2px 2px 0 rgba(63, 81, 181, 0.45), 0 3px 1px -2px rgba(63, 81, 181, 0.45), 0 1px 5px 0 rgba(156, 39, 176, 0.12)",
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        "0 14px 26px -12px rgba(63, 81, 181, 0.45), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(63, 81, 181, 0.45)"
    }
  },
  info: {
